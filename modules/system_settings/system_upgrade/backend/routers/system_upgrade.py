...
from ..services.git_client import list_branches
from ..services.diff_service import gen_diff
from ..services.upgrade_executor import run_execute
from ..services.snapshot_service import add_history, list_history, get_history, delete_history
...
def api_rollback(hid: str):
    ...
    row = add_history(branch=item["branch"], version=item["version"], files=item.get("files",[]), log="rollback to " + item["id"])
