...
import { LDialog } from "../../../../../navauth_shell/frontend/react/app/components/LDialog"
  ...
  return (
    <div className="space-y-4">
      ...
      <LDialog open={openLog} onOpenChange={setOpenLog} title="更新日志">
        <div className="text-sm text-slate-600">这里显示更新日志内容（从 /api/settings/system_settings/system_upgrade/history/{id}/log 获取）。</div>
      </LDialog>
    </div>
  )
}
