# -*- coding: utf-8 -*-
import os, glob, yaml, time, threading
...
def _validate_item(item: Dict[str, Any], path_stack: List[str], used_paths: set, used_orders: Dict[int, set], errors: List[str]) -> Dict[str, Any]:
    # 校验必填字段
